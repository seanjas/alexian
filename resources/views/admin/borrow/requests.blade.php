...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
               <div class="col-md-12">
                    <a class="btn btn-warning mb-3" href="{{ action('App\Http\Controllers\BorrowController@search') }}"><span class="fa fa-qrcode"></span> Search by QR</a>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="res_date_to_return" id="res_date_to_return" value="{{ return_on(\Carbon\Carbon::today(),$borrow_request->eqp_borrow_days) }}" readonly/>
                                                </div>
                                                <div class="form-group">
