            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Compose (individual)</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    @if(get_remaining_daily_credits() > 0)
                        ...
                        <div class="card card-info card-outline">
                            ...
                            <form method="POST" action="{{ action('App\Http\Controllers\SMSController@sendIndividual') }}">
                            {{ csrf_field() }}
                                <div class="card-body">
                                    <div class="form-group">
                                        <select class="select2" multiple="multiple" data-placeholder="Select recipients" style="width: 100%;" name="con_ids[]" required>
                                            @foreach($contacts as $contact)
                                                <option value="{{ $contact->con_id }}">{{ $contact->con_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
